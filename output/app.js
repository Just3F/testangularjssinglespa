...
(function() {
    ...
    var instantiatePromise = Promise.resolve()
      ...
      .then(function(registration) {
        ...
        function _export(name, value) {
          ...
          if (changed) for (var i = 0; i < importerSetters.length; i++) importerSetters[i](ns);
          return value;
        }
  ...
  systemJSPrototype.resolve = function(id, parentUrl) {
    ...
    return (
      resolveImportMap(this[IMPORT_MAP], resolveIfNotPlainOrUrl(id, parentUrl) || id, parentUrl) ||
  ...
  function loadScriptModules() {
    [].forEach.call(document.querySelectorAll('script[type=systemjs-module]'), function(script) {
      if (script.src) {
